...
import java.lang.*;
public class monster extends GameManager implements Runnable{
	...
	public void monsterMove(){
		for(int i=0,count=0;i<howMuchTime;i++){
			...
			if(RightOrLeft == 1 &&monsterIcon.getX()+movedist<1340){
				monster1=new ImageIcon("image\\monster\\ms.right.png");
				...
				monster1=new ImageIcon("image\\monster\\ms.left.png");
				monsterIcon.setIcon(monster1);
				monsterIcon.setLocation(monsterIcon.getX()-movedist,monsterIcon.getY());
			}
			try {
			...
			//System.out.println("Monster1 " + monsterIcon.getX() + " " + monsterIcon.getY());
		}
	}
	...
	public void monsterDieAndReborn(){
		if(health==1){ //death 		
			...
			*/
			...
			msh.start();
			if(RightOrLeft == 1) { monster1=new ImageIcon("image\\monster\\mdie2.gif"); }
			else{ monster1=new ImageIcon("image\\monster\\mdie1.gif"); }
			monsterIcon.setIcon(monster1);
			try { 
				Thread.sleep(80); 
			} 
			...
			if(RightOrLeft == 1) {monster1=new ImageIcon("image\\monster\\ms.right.png");}
			else{ monster1=new ImageIcon("image\\monster\\ms.left.png"); }
			monsterIcon.setIcon(monster1);
			health=3;
